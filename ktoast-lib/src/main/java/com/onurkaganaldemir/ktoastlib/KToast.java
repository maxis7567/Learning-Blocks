...
public class KToast {
    public static final int LENGTH_LONG = 4000, LENGTH_SHORT = 2000, LENGTH_AUTO = 250;
     ...
     * @param duration
     */
    public static void errorToast(final Activity activity, String message, final int gravity, int duration,int id){
     ...
     * @param duration
     */
    public static void warningToast(final Activity activity, String message, final int gravity, int duration,int id){
        if (KToast.id!=id) {
     ...
     * @param duration
     */
    public static void successToast(final Activity activity, String message, final int gravity, int duration,int id){
        if (KToast.id!=id) {
