...
import com.nova.maxis7567.learningblocks1.activity.SingleActivity;
...
public class ActivityAdapter extends RecyclerView.Adapter<ActivityAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.item_activity2,parent,false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        void bindItem(final Activity activity){
            Picasso.load(activity.getImage(),image,R.drawable.image_holder_spinner);
