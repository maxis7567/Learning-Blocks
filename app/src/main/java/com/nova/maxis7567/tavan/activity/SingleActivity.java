package com.nova.maxis7567.tavan.activity;
...
import com.nova.maxis7567.tavan.globaladapters.TagAdapter;
...
public class SingleActivity extends AppCompatActivity {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (message.equals("network not available")){
                            ...
                            dialogMessage.setCancelable(false);
                            dialogMessage.show();
                        }else if (message.equals("not a premiums user")){
    ...
    private void setUpView() {
        ...
        Picasso.load(data.getImage(),image,R.drawable.template_image1);
