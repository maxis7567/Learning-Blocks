...
import com.nova.maxis7567.tavan.models.Step;
...
//            }
        ...
        public void bindItem(final Step step) {
            ...
            if (step.getImage1()!=null||step.getImage3()!=null||step.getImage2()!=null){
                ...
                if (step.getImage1()!=null) {
                    Picasso.load(step.getImage1(), image1, R.drawable.template_image1);
                ...
                if (step.getImage2()!=null) {
                    Picasso.load(step.getImage2(), image2, R.drawable.template_image1);
                ...
                if (step.getImage3()!=null) {
                    Picasso.load(step.getImage3(), image3, R.drawable.template_image1);
